...
notebooks:
	find doc_template/examples_root/examples/nb -maxdepth 1 -name '*.ipynb' -exec jupyter-nbconvert --to notebook --execute --ExecutePreprocessor.timeout=1800 {} +
	find doc_template/examples_root/examples/nb/summer_workshop_2015 -maxdepth 1 -name '*.ipynb' -exec jupyter-nbconvert --to notebook --execute --ExecutePreprocessor.timeout=1800 {} +
